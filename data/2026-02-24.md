...
### [1] [From Static Spectra to Operando Infrared Dynamics: Physics Informed Flow Modeling and a Benchmark](https://arxiv.org/abs/2602.18551)
*Shuquan Ye, Ben Fei, Hongbin Xu, Jiaying Lin, Wanli Ouyang*

Main category: physics.chem-ph

TL;DR: 本文提出了一种新的任务“原位红外预测”，旨在仅从静态光谱预测锂离子电池的动态红外光谱演变，并提出了一种基于物理约束的深度学习框架ABCC。


<details>
  <summary>Details</summary>
Motivation: 原位红外光谱是研究固态电解质界面(SEI)的关键，但实验成本高昂，限制了其普及。本文旨在通过机器学习方法降低成本，使更多研究人员能够利用原位红外光谱。

Method: 提出了Aligned Bi-stream Chemical Constraint (ABCC)框架，该框架基于MeanFlow和Chemical Flow，采用双流机制分离溶剂和SEI，并施加质量守恒和峰位移动等物理约束。同时构建了OpIRSpec-7K，一个包含7118个样本的大规模原位数据集，以及OpIRBench基准测试。

Result: ABCC框架显著优于现有静态、序列和生成模型，能够泛化到未见过的电池系统，并支持SEI形成路径的可解释性恢复。

Conclusion: 本文提出的原位红外预测任务和ABCC框架为AI驱动的电化学发现提供了新的工具，有望加速锂离子电池材料和性能的优化。
